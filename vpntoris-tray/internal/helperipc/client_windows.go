...
// Ready reports whether the privileged helper named pipe accepts connections.
func Ready() bool {
...
// Call sends a validated request to the helper named pipe and returns its response.
